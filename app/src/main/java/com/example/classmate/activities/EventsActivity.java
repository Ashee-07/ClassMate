...
import com.example.classmate.adapters.EventAdapter;
import com.example.classmate.databinding.ActivityEventsBinding;
...
public class EventsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new EventAdapter(this, eventList, isAdmin);
        ...
        if (isAdmin) {
            ...
            binding.addFab.setOnClickListener(v -> startActivity(new Intent(this, AddEventActivity.class)));
        }
    ...
    private void fetchEvents() {
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                binding.emptyState.setVisibility(eventList.isEmpty() ? View.VISIBLE : View.GONE);
            }
